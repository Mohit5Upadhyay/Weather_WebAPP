...
const getCityCoordinates = () =>{
   ...
   const GEOCODING_API_URL =  `http://api.openweathermap.org/geo/1.0/direct?q=${cityName}&limit=1&appid=${API_KEY}` ; // it provide the location lattitude & longitude  -- by using the ---> OpenWeatherMap  API
